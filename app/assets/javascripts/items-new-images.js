...
//   var append_input = $(`<li class="input"><label class="upload-label"><div class="upload-label__text"><img src="icon/icon_camera.png" height="40" width="40"><br>ドラッグアンドドロップ<br>またはクリックしてファイルをアップロード<div class="input-area"><input class="hidden-image_upload" type="file" style="display:none;"></div></div></label></li>`)
//   $ul = $('#previews')
...
//   $(document).on('click', '.upload-label', function(){
